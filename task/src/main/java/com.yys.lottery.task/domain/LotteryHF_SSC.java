...
public class LotteryHF_SSC {
    ...
    public LotteryHF_SSC() {
    }

    public LotteryHF_SSC(Integer id, Integer planNo, String lotteryType, String lotteryName, String lotteryNo, String resultNum, String sum, String bullfight, String officialOpenTime, String nextOfficialOpenTime, String stopOrderTime) {
        this.id = id;
        this.planNo = planNo;
